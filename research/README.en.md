...
**Version:** 1.2.0 · **Command:** `/research`
...
**Prerequisite:** `PERPLEXITY_API_KEY` (starts with `pplx-`) as an environment variable — see [references/perplexity-api.en.md](references/perplexity-api.en.md). Without a key the QUICK tier (WebSearch) keeps working; DEEP is unavailable.
...
*Skill Version 1.2.0 | intentron Framework — vendored bundle skill (master: claudecodeskills)*
