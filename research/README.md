...
**Voraussetzung:** `PERPLEXITY_API_KEY` (beginnt mit `pplx-`) als Umgebungsvariable — siehe [references/perplexity-api.md](references/perplexity-api.md). Ohne Key läuft der QUICK-Tier (WebSearch) weiter; DEEP fällt aus.
