...
- `execution_isolation=worktree` in `CONVENTIONS.md`.
...
| 2 | Observe the three safety prerequisites | allowlist present, `execution_isolation=worktree` confirmed, bodyguard live — otherwise abort/pause |
